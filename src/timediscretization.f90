...
USE MOD_FiniteDifference2D_vars,ONLY: dt
USE MOD_FiniteDifference2D_vars,ONLY: tEnd
USE MOD_FiniteDifference2D_vars,ONLY: dt_Analyze
...
USE MOD_FiniteDifference2D,     ONLY: FDTimeDerivative
