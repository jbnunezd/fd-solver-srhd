...
!-------------------------------------------------------------------------------!
USE MOD_FiniteDifference2D_vars,ONLY: Kappa,KappaM1
!-------------------------------------------------------------------------------!
IMPLICIT NONE
!-------------------------------------------------------------------------------!
! >> FORMAL ARGUMENTS                                                           !
...
!-------------------------------------------------------------------------------!
USE MOD_FiniteDifference2D_vars,ONLY: nVar
USE MOD_FiniteDifference2D_vars,ONLY: MAXITER
USE MOD_FiniteDifference2D_vars,ONLY: Kappa, sKappaM1
USE MOD_FiniteDifference2D_vars,ONLY: EPS, ACCURACY
USE MOD_FiniteDifference2D_vars,ONLY: MIN_DENSITY, MIN_ENERGY, MIN_MOMENTUM
USE MOD_FiniteDifference2D_vars,ONLY: MIN_PRESSURE, MIN_SPEED, MAX_SPEED
!-------------------------------------------------------------------------------!
IMPLICIT NONE
!-------------------------------------------------------------------------------!
! >> FORMAL ARGUMENTS                                                           !
...
!-------------------------------------------------------------------------------!
USE MOD_FiniteDifference2D_vars,ONLY: nVar
USE MOD_FiniteDifference2D_vars,ONLY: MIN_RHO, MIN_PRESSURE, MIN_SPEED, MAX_SPEED
!-------------------------------------------------------------------------------!
IMPLICIT NONE
!-------------------------------------------------------------------------------!
! >> FORMAL ARGUMENTS                                                           !
...
Flux(1) = rho*LF*vy
Flux(2) = rho*h*LF2*vy*vx
Flux(3) = rho*h*LF2*vy*vy + p
Flux(4) = rho*h*LF2*vy
